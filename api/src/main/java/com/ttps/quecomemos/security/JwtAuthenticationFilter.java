    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (Arrays.stream(PUBLIC_ENDPOINTS)
                    .anyMatch(httpRequest.getRequestURI()::contains)
            ...
            ApiResponseDTO<String> unauthorizedResponseDTO = new ApiResponseDTO<>(
                    null, "Unauthorized: Invalid or missing token",
                    HttpStatus.UNAUTHORIZED);

            httpResponse.setStatus(HttpServletResponse.SC_UNAUTHORIZED);
            httpResponse.setContentType("application/json");
            new ObjectMapper().writeValue(httpResponse.getWriter(),
