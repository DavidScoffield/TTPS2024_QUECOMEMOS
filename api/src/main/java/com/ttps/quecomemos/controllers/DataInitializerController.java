...
public class DataInitializerController {
    ...
    public String initializeData() {
        ...
        foodService.registerNewFood(new FoodRegisterDTO("Hamburguesa", "Principal", false));
        foodService.registerNewFood(new FoodRegisterDTO("Papas Fritas", "Entrada", true));
        foodService.registerNewFood(new FoodRegisterDTO("Helado", "Postre", true));
        foodService.registerNewFood(new FoodRegisterDTO("Gaseosa", "Bebida", true));
        foodService.registerNewFood(new FoodRegisterDTO("Ravioles De Verdura", "Principal", true));
